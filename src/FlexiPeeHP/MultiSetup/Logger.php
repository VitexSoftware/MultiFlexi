...
//  [venue] => (string) FlexiPeeHP\MultiSetup\Ui\WebPage
...
//                    ['name' => 'resolved', 'type' => 'datetime', 'label' => _('Resolved')],
                    ['name' => 'application', 'type' => 'selectize', 'label' => _('Application'),
                        ...
                        'engine' => '\FlexiPeeHP\MultiSetup\Application',
                        'filterby' => 'name',
                    ],
                    ['name' => 'company', 'type' => 'selectize', 'label' => _('Company'),
                        ...
                        'engine' => '\FlexiPeeHP\MultiSetup\Company',
                        'filterby' => 'name',
                    ],
                    ['name' => 'user', 'type' => 'selectize', 'label' => _('User'),
                        ...
                        'engine' => '\FlexiPeeHP\MultiSetup\User',
                        'filterby' => 'name',
                    ],
        ]);
    }
