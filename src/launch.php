...
$oPage->container->addItem(new Panel(_('App Run'), 'info', $instanceRow, new \Ease\Html\DivTag(new \Ease\Html\IframeTag('run.php?id=' . \Ease\WebPage::getRequestValue('id'), ['id' => 'shell']), ['class' => 'iframe-container'])));
