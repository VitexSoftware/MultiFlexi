...
$rightColumn[] = new \Ease\Html\HrTag();
$rightColumn[] = new \Ease\TWB4\LinkButton('companysetup.php?id='.$companies->getMyKey(), '⚙&nbsp;'.  _('Company setup'),'light');
        
$instanceRow->addColumn(6, $rightColumn);
$bottomLine = new Row();
