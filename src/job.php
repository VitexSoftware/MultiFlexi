...
$oPage->container->addItem(
        new Panel([_('App Run'), $instanceRow], 'info', new \Ease\Html\DivTag(nl2br((new \SensioLabs\AnsiConverter\AnsiToHtmlConverter())->convert($jobber->getDataValue('stdout'))), ['style' => 'font-family: monospace; background-color: black;'])
