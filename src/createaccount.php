...
if ($oPage->isPosted()) {
    ...
    if ($error == false) {
        $newAdmin = new \FlexiPeeHP\MultiSetup\User();
        ...
        if ($newAdmin->dbsync([
            ...
            $email->addItem(new \Ease\Html\DivTag("Your new TaxTorro accont:\n"));
...
$regForm = $regFace->addItem(new ColumnsForm(new \FlexiPeeHP\MultiSetup\User()));
if ($oUser->getUserID()) {
