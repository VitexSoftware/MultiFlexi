...
class PageBottom extends \Ease\Html\FooterTag
{
    ...
    public function finalize(): void
    {
        ...
        $author = '<strong><a href="https://multiflexi.eu/">Multi Flexi</a></strong> '.\Ease\Shared::appVersion().(empty(self::BUILD) ? '' : '&nbsp;'._('build').' #'.self::BUILD).'<br>'._('the age of the installation').'&nbsp;&nbsp; &copy; 2020-2024 <a href="https://vitexsoftware.com/">Vitex Software</a>';
