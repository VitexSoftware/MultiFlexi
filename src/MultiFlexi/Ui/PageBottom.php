...
class PageBottom extends \Ease\Html\FooterTag
{
    ...
    public function finalize()
    {
        ...
        $author = '<strong>Multi Flexi</strong> ' . \Ease\Shared::appVersion() . (empty(self::BUILD) ? '' : '&nbsp;' . _('build') . ' #' . self::BUILD) . '<br>' . _('the age of the installation') . '&nbsp;' . new \Ease\ui\LiveAge(filemtime($composer)) . '&nbsp;&nbsp; &copy; 2020-2024 <a href="https://vitexsoftware.com/">Vitex Software</a>';
