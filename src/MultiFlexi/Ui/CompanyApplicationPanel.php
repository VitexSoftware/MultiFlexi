...
class CompanyApplicationPanel extends Panel
{
    ...
    public function __construct(\MultiFlexi\CompanyApp $companyApp, $content = null, $footer = null)
    {
        ...
        $usedByCompany->addItem(new \Ease\TWB5\Card([new \Ease\Html\DivTag([new \Ease\Html\H5Tag([_('Active RunTemplates').': ', ' <small>'.$crls->count().'</small>'], ['class' => 'card-title']), $crls], ['class' => 'card-body'])], ['style' => 'width: 6rem;']));
