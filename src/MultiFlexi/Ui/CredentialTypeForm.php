...
class CredentialTypeForm extends SecureForm
{
    ...
    public function __construct(\MultiFlexi\CredentialType $credtype, $formProperties = [])
    {
        ...
        $helperCol = $credTypeRow1->addColumn(6, new \Ease\TWB4\FormGroup(_('Credential type Helper Class'), new CredentialTypeClassSelect('class', [], (string) $credtype->getDataValue('class'))));
