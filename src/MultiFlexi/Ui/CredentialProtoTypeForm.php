...
JS;
        ...
        if (null === $prototype->getMyKey()) {
            $submitRow->addColumn(6, new \Ease\TWB4\SubmitButton(_('Create Prototype'), 'success btn-lg btn-block', ['name' => 'create']));
            $submitRow->addColumn(6, new \Ease\TWB4\LinkButton('credentialprototypes.php', _('Cancel'), 'secondary btn-lg btn-block'));
        } else {
