...
class CompaniesBar extends \Ease\Html\DivTag
{
    public function __construct(array $properties = [])
    {
        ...
        foreach ($companies as $companyData) {
            ...
            $companyAppCard->addItem(new \Ease\Html\ATag('company.php?id='.$companyData['id'], new \Ease\Html\ImgTag($companyData['logo'], $companyData['name'], ['title' => $companyData['slug'], 'class' => 'card-img-top', 'style' => 'padding: 5px; margin: 5px;max-height: 150px;max-width: 150px;'])));
