...
{
    /**
     * @var Credential|\PHPUnit\Framework\MockObject\MockObject
     */
    private $credentialMock;

    /**
     * @var CredentialType|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    public function testInheritedMethods(): void
    {
        ...
        foreach ($credentialConfigFields as $key => $field) {
            $fieldCount++;
            $this->assertTrue(in_array($key, ['field1', 'field2']));
